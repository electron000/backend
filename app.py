...
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY','xREz9ZXaDs3dX/3t1NLHHVR+0sL8LFr4Ru0s5KnAfMKU6cKZqkBdjwYv8tSKtxZP')
ADMIN_DEFAULT_PASSWORD = os.environ.get('ADMIN_DEFAULT_PASSWORD','0123')
USER_DEFAULT_PASSWORD = os.environ.get('USER_DEFAULT_PASSWORD','4567')
